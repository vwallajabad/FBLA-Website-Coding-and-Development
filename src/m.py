...
<form class="custom-form-width" id="application-form">
    <div class="container mt-5">
      ...
      <div class="mb-3">
        ...
        <textarea class id="experience" rows="3" placeholder="Please list your experience in under 1000 characters." required></textarea>
      </div>
      <button type="submit" class="btn" style="background-color: rgb(80,103,136); border: solid 2px black; color:white; padding: 12px 12px 12px 12px;">Submit Application</button>
    </div>
  </form>
          <script>
